...
--
-- Host: localhost    Database: BDInventarioLindin
-- ------------------------------------------------------
...
--
-- Current Database: `BDInventarioLindin`
--

/*!40000 DROP DATABASE IF EXISTS `BDInventarioLindin`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `BDInventarioLindin` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;

USE `BDInventarioLindin`;
...
CREATE TABLE `dispositivos` (
  ...
  `fechaBajaDispositivo` date NOT NULL,
...
CREATE TABLE `equipos` (
  ...
  `fechaCompraEquipo` date NOT NULL,
  `fechaBajaEquipo` date NOT NULL,
  `idUbicacion` smallint(6) NOT NULL,
...
-- Dump completed on 2022-04-27 21:46:46
